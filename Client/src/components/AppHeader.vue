        ...
        <nav class="space-x-4">
          <div v-if="loggedInUsername" class="flex items-center">
            <router-link to="/profile" class="hover:bg-purple-200 px-3 py-1 rounded transition text-lg font-bold flex items-center">
              <span style="color: #0c7175;">@{{ loggedInUsername }}</span>
              <svg class="ml-3" xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 -960 960 960" width="24">
          ...
          <router-link v-else to="/login" class="hover-bg-green-200 text-green-700 px-3 py-1 rounded transition text-lg font-bold">Log In</router-link>
