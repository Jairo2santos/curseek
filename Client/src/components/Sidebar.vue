<template>
  <div>
    <div class="flex items-center mb-4">
      ...
      <button v-if="selectedCategory !== null" @click="clearSelectedCategory"
    ...
    <div class="md:text-md bg-white md:max-w-md lg:max-w-lg rounded-t-md">
      <div class="">
        <button @click="dropdownOpen = !dropdownOpen"
          ...
          <!-- {{ selectedCategory !== null ? 'Categoría: ' + capitalize(selectedCategory) : 'Categoría' }} -->
          <span>Categoría</span>
...
watch(selectedCategory, (newVal) => {
  emit('filter-by-category', newVal); // Emitir evento con la categoría seleccionada
