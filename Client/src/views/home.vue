<template>
  <div class="p-0 min-h-screen bg-white">
    <!-- Buscador -->
    <div
      class="flex flex-col md:flex-row container mx-auto md:pl-40 pl-0 bg-white pb-12"
    >
      ...
      <div class="md:w-1/2 p-8 flex flex-col justify-center">
          ...
          >
            ...
            <ul>
              <li
                ...
                :key="course.slug"
                class="border-b last:border-b-0 pb-2 md:pb-0"
              >
                <a
                ...
                >
                  ...
                  <div
                    class="flex items-end text-sm font-semibold text-green-700"
                  >
        ...
        <div class="mt-4 pr-0 md:pr-20">
          ...
          <button
            @click="handleSearch('Desarrollo web')"
            @focus="setInputClicked(true)"
            @blur="setInputClicked(false)"
            class="text-sm bg-gray-100 text-gray-800 hover:bg-indigo-200 border border-gray-200 transition py-1 px-2 rounded-full mb-1 mr-1"
          >
          ...
          <button
            @click="handleSearch('Estilos CSS')"
            @focus="setInputClicked(true)"
            @blur="setInputClicked(false)"
            class="text-sm bg-gray-100 text-gray-800 hover:bg-indigo-200 border border-gray-200 transition py-1 px-2 rounded-full mb-1 mr-1"
          >
          ...
          <button
            @click="handleSearch('Curso de php')"
            @focus="setInputClicked(true)"
            @blur="setInputClicked(false)"
            class="text-sm bg-gray-100 text-gray-800 hover:bg-indigo-200 border border-gray-200 transition py-1 px-2 rounded-full mb-1 mr-1"
          >
          ...
          <button
            @click="handleSearch('Administración de empresas')"
            @focus="setInputClicked(true)"
            @blur="setInputClicked(false)"
            class="text-sm bg-gray-100 text-gray-800 hover:bg-indigo-200 border border-gray-200 transition py-1 px-2 rounded-full mb-1 mr-1"
          >
    ...
    >
      ...
      <img
        src="../assets/banner-curseek-2.png"
        alt=""
              ...
              <li class="flex items-center justify-center">
                <a href="/cursos/udemy">
                  ...
                  >
                    <img
                      class="w-12"
                      src="../assets/instituciones/Udemy.png"
                      alt="Udemy"
                    />
              ...
              <li class="flex items-center justify-center">
                <a href="/cursos/utn">
                  ...
                  >
                    <img
                      class="w-12"
                      src="../assets/instituciones/utn.png"
              ...
              <li class="flex items-center justify-center">
                <a href="https://www.coursera.org" target="_blank">
                  ...
                  >
                    <img
                      class="w-12"
                      src="../assets/instituciones/coursera.png"
                      alt="Coursera"
                    />
                    <span class="ml-2 text-lg font-semibold text-black"
                      >Coursera</span
      ...
      <div class="flex flex-wrap pb-6 md:px-40">
          ...
          <div class="p-4">
            ...
            <ul>
              <li class="flex items-center">
                <p class="text-sm">
                  Explora cursos por destacadas universidades como UTN, U. de
                  Chile, UNAM, y muchas otras.
                </p>
              </li>
            </ul>
          </div>
        ...
        >
          ...
          <div class="p-4">
            ...
            <ul>
              <li class="flex items-center">
                <p class="text-sm">
                  Utiliza nuestro botón de "Seguir" para asegurarte de no
                  perderte nunca un curso importante en tu trayectoria
                  educativa.
                </p>
              </li>
            </ul>
        ...
        >
          ...
          <div class="p-4">
            ...
            <ul>
              <li class="flex items-center">
                <p class="text-sm">
                  Marca tus cursos favoritos o crea trayectorias personalizadas
                  de aprendizaje utilizando recursos de cualquier parte de la
                  web.
                </p>
              </li>
            </ul>
        ...
        <div class="pt-6 pb-12 px-14 md:px-60">
          <p class="text-center text-md text-gray-700">
            ...
            obtén los datos y perspicacia esenciales para destacar en el
            emocionante ámbito de la educación en línea. Descubre, aprende y
            alcanza tus metas académicas con Curseek.
          </p>
          <a
            href="/signUp"
...
const search = async () => {
  try {
    const response = await axios.get(
      `http://localhost:3333/cursos/search?q=${
        query.value
