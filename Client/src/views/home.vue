<template>
  <div>
    ...
    <div class="p-4 min-h-screen flex flex-col items-center bg-purple-500">
      <div class="text-center mb-4"> <!-- Reducido el margen inferior -->
        <h1 class="text-2xl font-extrabold text-white">Encuentra tu Curso</h1> <!-- Tamaño de fuente reducido -->
      </div>
      ...
      <div class="max-w-screen-xl mx-auto w-full flex items-center justify-center">
        ...
        <div class="bg-white w-full md:w-1/2 md:ml-0 md:mr-auto border rounded-xl">
          <form @submit.prevent="search" class="flex items-center overflow-hidden shadow-md p-2">
            <svg xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 -960 960 960" width="24">
              <path d="M784-120 532-372q-30 24-69 38t-83 14q-109 0-184.5-75.5T120-580q0-109 75.5-184.5T380-840q109 0-184.5 75.5T640-580q0 44-14 83t-38 69l252 252-56 56ZM380-400q75 0 127.5-52.5T560-580q0-75-52.5-127.5T380-760q-75 0-127.5 52.5T200-580q0 75 52.5 127.5T380-400Z"/>
            </svg>
            <input v-model="query" placeholder="Buscar cursos..." class="p-2 flex-grow outline-none" @focus="blurBackground" @blur="unblurBackground"/>
          </form>
        </div>
        ...
        <div class="w-2/3 md:w-1/3 md:ml-auto md:mr-0 mt-6">
            <img class="w-full" src="../assets/similarweb.jpeg" alt="Never stop learning.">
