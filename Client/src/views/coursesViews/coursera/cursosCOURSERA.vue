<template>
  <div class="bg-white">
    ...
    :instagramLink="'https://www.instagram.com/coursera/'"
    :twitterLink="'https://twitter.com/coursera'"
                  ...
                  <div class="flex flex-col md:flex-row items-start">
                    <div class="flex flex-col">
                      ...
                      <div class="flex flex-col mb-2 items-center md:flex-row">
                        <!-- Imagen del curso -->
                        <img :src="course.imgUrl" alt="" class="w-32 h-auto rounded mb-2 md:mb-0 md:mr-2"/>
                        <!-- Título del curso -->
                      ...
                      <ul>
                        ...
                        <li class="flex text-sm text-black p-2">
                          <svg class="mr-2" fill="#057500" xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 -960 960 960" width="24">
                            <path d="M542.308-131.692q-11.529 11.461-28.573 11.461-17.043 0-28.504-11.461l-352-352q-6.385-6.385-9.808-14.02T120-514v-286q0-16.077 11.961-28.039Q143.923-840 160-840h286q7.769 0 15.452 3.166 7.683 3.167 13.317 8.526l352 352.231Q839-463.846 839.385-446.5q.384 17.346-11.077 28.808l-286 286ZM259.91-660q16.629 0 28.359-11.64Q300-683.281 300-699.909q0-16.63-11.64-28.36Q276.72-740 260.09-740q-16.629 0-28.359 11.64Q220-716.719 220-700.091q0 16.63 11.64 28.36Q243.28-660 259.91-660Z"></path>
                          </svg>
...
const pageDescription =
  "Coursera es una plataforma de educación en línea, especializaciones y grados de universidades y organizaciones reconocidas. Los cursos incluyen videos, lecturas y foros. Algunos son gratuitos, pero también hay opciones pagas para obtener certificados. Coursera contiene educación de calidad para mejorar habilidades o avanzar profesionalmente.";
const courses = ref([]);
