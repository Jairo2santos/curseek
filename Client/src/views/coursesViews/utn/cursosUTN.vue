          ...
          <div v-for="course in courses" :key="course._id" class="mb-5">
            ...
            <router-link :to="'/curso/' + course._id" class="block max-w-full bg-white mt-2 rounded-lg p-4 hover:shadow-lg transition">
              ...
              <div class="flex flex-col md:flex-row items-start md:items-start">
                <!-- Imagen del curso -->
                <img :src="course.imgUrl" alt="Imagen del curso" class="w-full md:w-1/5 rounded mb-4 md:mb-0 md:mr-4">

                <!-- Contenido del curso -->
                <div class="ml-0 flex-grow">
                  <!-- Título del curso -->
                  <h2 class="text-lg md:text-xl font-semibold mb-2 hover:underline mr-20">
                    {{ course.title }}
                  </h2>
                  ...
                  <p class="text-sm text-gray-600 mr-20">
                    <!-- {{ course.description }} -->
                    Lorem, ipsum dolor sit amet consectetur adipisicing elit. Eos alias nesciunt debitis corrupti quod? Ratione fuga aut maiores vero tempora exercitationem dolores vel saepe corporis velit et, accusantium modi esse.
                  </p>
                </div>

                <!-- Sección derecha con categoría, precio y cursada -->
                <div class="md:w-1/4 md:flex md:flex-col md:items-end text-left p-4" style="border-left: solid rgba(211, 211, 211, 0.322) .01rem;">
                  <ul>
                    <!-- Categoría -->
                    <li class="flex text-sm text-black p-2" style="border-bottom: solid rgba(211, 211, 211, 0.322) .01rem;">
                    ...
                    <!-- Cursada -->
                    <li class="flex text-sm text-black text-red-700 p-2 text-center" style="border-bottom: solid rgba(211, 211, 211, 0.322) .01rem;">
                      {{ course.startDate }}
                    </li>
                    <!-- Precio -->
...
// Estado
const pageTitle = "Cursos de la UTN";
