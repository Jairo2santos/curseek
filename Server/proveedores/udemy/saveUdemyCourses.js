...
async function saveUdemyCourses() {
  try {
    const fields = 'id,title,url,is_paid,price,visible_instructors,image_125_H,image_240x135,image_480x270,published_title,locale,headline,archive_time,avg_rating,completion_ratio,created,description,favorite_time,num_lectures,num_quizzes,num_subscribers,primary_category,primary_subcategory,status_label';
    const headers = {
